...
package com.service.service.entity.masterdata.location;
...
import com.service.service.entityListener.masterdata.location.LocationEntityListener;
...
public class LocationEntity { 
    ...
    @Column(name = "sys_id_m_location", updatable = false, nullable = false)
    private String id;

    @Column( name = "name_m_location" )
