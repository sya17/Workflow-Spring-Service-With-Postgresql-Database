...
import com.service.service.entityListener.masterdata.type.CityEntityListener;
...
public class CityEntity { 
    ...
    @Column(name = "sys_id_m_city", updatable = false, nullable = false)
    private String id;

    @Column( name = "name_m_city" )
