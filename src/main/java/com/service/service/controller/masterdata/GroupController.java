...
import com.service.service.service.masterdata.GroupService;
import com.service.service.dto.masterdata.GroupDTO;
import com.service.service.entity.masterdata.GroupEntity;


@RestController
@RequestMapping("/group")
public class GroupController extends CommonUtil { 
    ...
    @PostMapping
    ResponseEntity<ResponseUtils> create(@RequestBody @Valid GroupDTO dto) {
        GroupEntity entity = service.save(ConvertModel(dto, GroupEntity.class));
        GroupDTO res = ConvertModel(entity, GroupDTO.class);
    ...
    @PutMapping()
    ResponseEntity<ResponseUtils> update(@RequestBody @Valid GroupDTO dto) {
        GroupEntity entity = service.update(dto.getId(),
                ConvertModel(dto, GroupEntity.class));
        Object res = (entity == null ? (dto.getId() + " Not Found")
                : ConvertModel(entity, GroupDTO.class));
        return ResponseEntity
                .status(HttpStatus.OK)
                .contentType(MediaType.APPLICATION_JSON)
                .body(
