...
package com.service.service.controller.masterdata.location;
...
import com.service.service.service.masterdata.location.LocationService;
import com.service.service.dto.masterdata.location.LocationDTO;
import com.service.service.entity.masterdata.location.LocationEntity;


@RestController
@RequestMapping("/location")
public class LocationController extends CommonUtil { 
    ...
    @PostMapping
    ResponseEntity<ResponseUtils> create(@RequestBody @Valid LocationDTO dto) {
        LocationEntity entity = service.save(ConvertModel(dto, LocationEntity.class));
        LocationDTO res = ConvertModel(entity, LocationDTO.class);
    ...
    @PutMapping()
    ResponseEntity<ResponseUtils> update(@RequestBody @Valid LocationDTO dto) {
        LocationEntity entity = service.update(dto.getId(),
                ConvertModel(dto, LocationEntity.class));
        Object res = (entity == null ? (dto.getId() + " Not Found")
                : ConvertModel(entity, LocationDTO.class));
        return ResponseEntity
        ...
        ResponseEntity<ResponseUtils> getAll(
                ...
                Object res = null;
                Page<LocationEntity> dataPage = null;
                if (page != null) {
                        dataPage = service
