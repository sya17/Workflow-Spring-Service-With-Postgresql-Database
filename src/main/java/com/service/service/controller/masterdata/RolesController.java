...
import com.service.service.service.masterdata.RolesService;
import com.service.service.dto.masterdata.RolesDTO;
import com.service.service.entity.masterdata.RolesEntity;


@RestController
@RequestMapping("/roles")
public class RolesController extends CommonUtil { 
    ...
    @PostMapping
    ResponseEntity<ResponseUtils> create(@RequestBody @Valid RolesDTO dto) {
        RolesEntity entity = service.save(ConvertModel(dto, RolesEntity.class));
        RolesDTO res = ConvertModel(entity, RolesDTO.class);
    ...
    @PutMapping()
    ResponseEntity<ResponseUtils> update(@RequestBody @Valid RolesDTO dto) {
        RolesEntity entity = service.update(dto.getId(),
                ConvertModel(dto, RolesEntity.class));
        Object res = (entity == null ? (dto.getId() + " Not Found")
                : ConvertModel(entity, RolesDTO.class));
        return ResponseEntity
                .status(HttpStatus.OK)
                .contentType(MediaType.APPLICATION_JSON)
                .body(
