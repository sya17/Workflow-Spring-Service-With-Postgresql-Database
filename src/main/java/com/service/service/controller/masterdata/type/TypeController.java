...
import com.service.service.service.masterdata.type.TypeService;
import com.service.service.dto.masterdata.type.TypeDTO;
import com.service.service.entity.masterdata.type.TypeEntity;


@RestController
@RequestMapping("/type")
public class TypeController extends CommonUtil { 
    ...
    @PostMapping
    ResponseEntity<ResponseUtils> create(@RequestBody @Valid TypeDTO dto) {
    ...
    @PutMapping()
    ResponseEntity<ResponseUtils> update(@RequestBody @Valid TypeDTO dto) {
        TypeEntity entity = service.update(dto.getId(),
                ConvertModel(dto, TypeEntity.class));
        Object res = (entity == null ? (dto.getId() + " Not Found")
                : ConvertModel(entity, TypeDTO.class));
        return ResponseEntity
