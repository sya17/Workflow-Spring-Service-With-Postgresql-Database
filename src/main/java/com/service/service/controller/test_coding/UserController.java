...
import com.service.service.service.test_coding.UserService;
import com.service.service.dto.test_coding.UserDTO;
...
public class UserController extends CommonUtil { 
    ...
    @PostMapping
    ResponseEntity<ResponseUtils> create(@RequestBody @Valid UserDTO dto) {
        UserEntity entity = service.save(ConvertModel(dto, UserEntity.class));
        UserDTO res = ConvertModel(entity, UserDTO.class);
    ...
    @PutMapping()
    ResponseEntity<ResponseUtils> update(@RequestBody @Valid UserDTO dto) {
        UserEntity entity = service.update(dto.getId(),
                ConvertModel(dto, UserEntity.class));
        Object res = (entity == null ? (dto.getId() + " Not Found")
                : ConvertModel(entity, UserDTO.class));
        return ResponseEntity
