...
package com.service.service.controller.test_coding;
...
import com.service.service.service.test_coding.DepartementService;
import com.service.service.dto.test_coding.DepartementDTO;
import com.service.service.entity.test_coding.DepartementEntity;


@RestController
@RequestMapping("/departement")
public class DepartementController extends CommonUtil { 
    ...
    @PostMapping
    ResponseEntity<ResponseUtils> create(@RequestBody @Valid DepartementDTO dto) {
        DepartementEntity entity = service.save(ConvertModel(dto, DepartementEntity.class));
        DepartementDTO res = ConvertModel(entity, DepartementDTO.class);
    ...
    @PutMapping()
    ResponseEntity<ResponseUtils> update(@RequestBody @Valid DepartementDTO dto) {
        DepartementEntity entity = service.update(dto.getId(),
                ConvertModel(dto, DepartementEntity.class));
        Object res = (entity == null ? (dto.getId() + " Not Found")
                : ConvertModel(entity, DepartementDTO.class));
        return ResponseEntity
        ...
        ResponseEntity<ResponseUtils> getAll(
                ...
                Object res = null;
                Page<DepartementEntity> dataPage = null;
                if (page != null) {
                        dataPage = service
